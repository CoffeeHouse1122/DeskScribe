...
const MODEL_CATALOG: readonly ModelDefinition[] = [
  {
    ...
    description: "中英文与混合语言首选；接近 Large V3 的识别质量，速度更快。仅用于原语言转写。",
    hardwareHint: "约 1.62 GB · 建议 8 GB 以上内存",
    languageHint: "多语言 · 中英文推荐",
    version: "1",
    recommended: true,
  ...
  },
  {
    ...
    description: "英语专项的高速模型；英文长音频效率高，不建议用于中文或中英混合内容。",
    hardwareHint: "约 1.52 GB · 英语场景低延迟",
    languageHint: "英语专项",
    version: "1",
    recommended: false,
    files: fasterWhisperFiles(
  ...
  },
  {
    ...
    description: "轻量稳定的多语言模型；适合 CPU、低内存设备和快速接入，精度低于 Large 系列。",
    hardwareHint: "约 488 MB · 低配置优先",
    languageHint: "多语言 · 轻量",
    version: "1",
    recommended: false,
    files: [
  ...
  },
  {
    ...
    description: "Whisper.cpp 高精度量化模型；中英文通用，质量优先，但转写速度和内存开销更高。",
    hardwareHint: "约 1.08 GB · 建议 8 GB 以上内存",
    languageHint: "多语言 · 高精度",
    version: "1",
    recommended: false,
    files: [
      {
